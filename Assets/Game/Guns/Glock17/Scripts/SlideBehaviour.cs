...
public class SlideBehaviour : MonoBehaviour
{
    ...
    {
        GameObject cartridge = PoolingSystem.instance.InstantiateObject(PoolingSystem.PoolObject.Cartridge9mm, ejectPoint.position, ejectPoint.rotation);
    ...
    {
        gunInformation.hasBulletInChamber = false;
        GameObject bullet = PoolingSystem.instance.InstantiateObject(PoolingSystem.PoolObject.bullet9mm, ejectPoint.position, ejectPoint.rotation);
