...
public class GrabBehaviour : MonoBehaviour
{
    ...
    [Foldout("References", true)] [SerializeField, ReadOnly]
    ...
    private void OnValidate()
    {
        ...
        if (!handPulseController)
        {
            handPulseController = hand.GetComponentInChildren<HandPulseController>();
        }
    }
    ...
    private void Scaning()
    {
        ...
        {
            if (!inputManager.grabPressing.GetStateUp(hand.handType))
            {
                return;
            }
    ...
    public void GrabEnding()
    {
        ...
        if (!inputManager.grabPressing.GetStateDown(hand.handType))
        {
            return;
        }
