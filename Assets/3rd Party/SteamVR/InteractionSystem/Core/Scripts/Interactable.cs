...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        [Tooltip("Set whether or not you want this interactible to highlight when hovering over it and it is already attached to another hand")]
        public bool highlightWhenInOtherHand = false;
        ...
        protected virtual void UpdateHighlightRenderers()
        {
            ...
            for (int skinnedIndex = 0; skinnedIndex < existingSkinnedRenderers.Length; skinnedIndex++)
            {
                ...
                if (existingSkinned != null && highlightSkinned != null && (attachedToHand == false || highlightWhenInOtherHand))
                {
            ...
            for (int rendererIndex = 0; rendererIndex < highlightRenderers.Length; rendererIndex++)
            {
                ...
                if (existingRenderer != null && highlightRenderer != null && (attachedToHand == false || highlightWhenInOtherHand))
                {
